...
function CCBox() {
    ...
    const data = [
        {
            ...
            al : 'gender',
            val : value1, method1 : handleChange1,
        },
        {
            title : 'Your Crush Name', name : 'name2',
            radioGroupName : 'genderf2',
            al : 'gender',
            val : value2, method1 : handleChange2,
        },
    ]
    ...
    const dataMap = data.map( (dal) =>
        <div>
            ...
            <FormControl>
                <RadioGroup aria-label={dal.al} name={dal.radioGroupName} value={dal.val} onChange={dal.method1} classes={{root : classes.rootRadioGroup}}>
                    <FormControlLabel 
                        value="female" 
                        control={ 
                            <Radio 
